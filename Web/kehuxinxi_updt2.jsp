...
new CommDAO().update(request,response,"kehuxinxi",ext,true,false,""); 
HashMap mmm = new CommDAO().getmaps("yonghuming",(String)request.getSession().getAttribute("username"),"kehuxinxi"); 
%>
  <form  action="kehuxinxi_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改客户信息:
  <br><br>
  <%
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr><td>手机号码：</td><td><input name='shoujihaoma' type='text' id='shoujihaoma' value='<%= mmm.get("shoujihaoma")%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
