...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var cheliangleibieobj = document.getElementById("cheliangleibie"); if(cheliangleibieobj.value==""){document.getElementById("clabelcheliangleibie").innerHTML="&nbsp;&nbsp;<font color=red>请输入车辆类别</font>";return false;}else{document.getElementById("clabelcheliangleibie").innerHTML="  "; } 
